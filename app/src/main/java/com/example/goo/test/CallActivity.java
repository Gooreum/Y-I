...
import com.example.goo.test.AppRTCAudioManager.AudioDevice;
import com.example.goo.test.AppRTCAudioManager.AudioManagerEvents;
import com.example.goo.test.AppRTCClient.RoomConnectionParameters;
import com.example.goo.test.AppRTCClient.SignalingParameters;
import com.example.goo.test.PeerConnectionClient.DataChannelParameters;
import com.example.goo.test.PeerConnectionClient.PeerConnectionParameters;
...
public class CallActivity extends Activity implements AppRTCClient.SignalingEvents,
    ...
    private void requestRecordAudioPermission() {
        ...
        String requiredPermission2 = Manifest.permission.CAMERA;
        ...
        if (getApplicationContext().checkCallingOrSelfPermission(requiredPermission) == PackageManager.PERMISSION_GRANTED) {
            ...
            Toast.makeText(CallActivity.this, "This app needs to record audio through the microphone....", Toast.LENGTH_SHORT).show();
