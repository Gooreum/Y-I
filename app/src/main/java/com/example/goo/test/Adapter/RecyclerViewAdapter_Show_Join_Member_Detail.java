...
import static com.example.goo.test.Activity.Home.Content_Detail_Activity.project_email_detail;
import static com.example.goo.test.Activity.Home.Content_Detail_Activity.project_id_detail;
import static com.example.goo.test.Activity.Home.Content_Detail_Activity.selected_count_detail;
import static com.example.goo.test.Activity.Home.Content_Detail_Activity.txt_selected_num_detail;
...
public class RecyclerViewAdapter_Show_Join_Member_Detail extends RecyclerView.Adapter<RecyclerViewAdapter_Show_Join_Member_Detail.MyViewHolder> {
    private List<ListItem_Check_Join_Member> listItems;
    Context context;

    int selected_num = selected_count_detail;
    ...
    //어댑터 생성자
    public RecyclerViewAdapter_Show_Join_Member_Detail(Context context, List<ListItem_Check_Join_Member> listItems) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.card_view_check_join_member_detail, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        if(item.me == true){
            ...
            holder.btn_relative.setVisibility(View.GONE);
        }

        //모집인원과 선택된 인원이 같을 경우 '프로젝트 시작'버튼을 보이게 한다.
     /*   if(join_count <= selected_num){
                ...
                public void onClick(View view) {
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.POST, JOIN_URL,
                        ...
                        protected Map<String, String> getParams() {
                            ...
                            params.put("project_id", String.valueOf(project_id_detail));
        ...
        //내 모집글에서 '함께하기 취소' 버튼을 눌렀을 때!
                ...
                public void onClick(View view) {
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.POST, JOIN_URL,
                            new Response.Listener<String>() {
                                ...
                                public void onResponse(String response) {
                                    if (response.contains("1")) {
                                        ...
                                        Toast.makeText(context, "1", Toast.LENGTH_LONG).show();
                                        selected_count_detail = selected_count_detail - 1;
                                        txt_selected_num_detail.setText(selected_count_detail + " ");
                        ...
                        protected Map<String, String> getParams() {
                            ...
                            params.put("project_id_cancel", String.valueOf(project_id_detail));
            ...
            if (project_email_detail.equals(loadLoginEmail())) {
                holder.btn_relative.setVisibility(View.VISIBLE);
