...
public class RecyclerViewAdapter_Show_Developing_Project extends RecyclerView.Adapter<RecyclerViewAdapter_Show_Developing_Project.MyViewHolder> {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (pos != RecyclerView.NO_POSITION) {
                        ...
                        //진행중이지만 추가모집중이라면 '추가모집 상태'와 추가모집 인원을 보내준다.
                       if(listItems.get(pos).project_recruting == 1 ){
                           intent.putExtra("project_recruting",listItems.get(pos).project_recruting);
                           intent.putExtra("more_recruit_member",listItems.get(pos).more_recruit_member);
                           intent.putExtra("project_developing",listItems.get(pos).project_developing);
                           //추가모집 상태가 아니라면 '진행중인 상태'만 보내준다.
                       }else {
                           intent.putExtra("project_developing",listItems.get(pos).project_developing);
                           intent.putExtra("project_recruting",listItems.get(pos).project_recruting);
                       }
    ...
    //어댑터 생성자
    public RecyclerViewAdapter_Show_Developing_Project(Context context, List<ListItem_Show_Project> listItems) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_view_developing_project, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        if (item.getMe() == true || item.project_recruting == 0) {
        ...
        } else if(item.getMe() == false && item.project_recruting == 1){
