...
public class RecyclerViewAdapter_Show_Chatting_Member extends RecyclerView.Adapter<RecyclerViewAdapter_Show_Chatting_Member.MyViewHolder> {
...
//            btn_unfollow.setVisibility(View.VISIBLE);
    ...
    //어댑터 생성자
    public RecyclerViewAdapter_Show_Chatting_Member(Context context, List<ListItem_Check_Like_Member> listItems) {
