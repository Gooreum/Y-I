...
public class CompletedProjectFragment_tab extends Fragment {
    // Required empty public constructor
    public CompletedProjectFragment_tab() {
    ...
    public void uploadProject() {
         ...
         stringRequest = new StringRequest(Request.Method.POST, SHOW_URL,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonarray.length(); i++) {
                                ...
                                item.selected_num = object.getInt("selected_num")+1;
                            ...
                            RecyclerViewAdapter_Show_Completed_Project adapter = new RecyclerViewAdapter_Show_Completed_Project(getContext(), listItems);
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("email_completed", loadLoginEmail());
