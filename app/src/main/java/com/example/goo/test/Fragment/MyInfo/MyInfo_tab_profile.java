...
import com.example.goo.test.Activity.MyInfo.Profile_Detail;
...
public class MyInfo_tab_profile extends Fragment implements View.OnClickListener {
    ...
    String email2;
    TextView email, name, txt_content_count, txt_follower_count, txt_following_count,  bottom_interest, bottom_myskill, bottom_career, bottom_exp, bottom_recommend;
    ImageView btn_profile_detail, add_interest, add_career, add_myskill, add_exp, add_recommend, logout;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       ...
       // intro = rootView.findViewById(R.id.intro);
        ...
        add_recommend.setVisibility(View.GONE);
        ...
        //프로필 상세 입력하기 화면으로 전환
        btn_profile_detail.setOnClickListener(this);
        ...
        //각각의 프로필 추가 버튼
        add_myskill.setOnClickListener(this);
        add_interest.setOnClickListener(this);
        add_exp.setOnClickListener(this);
        add_career.setOnClickListener(this);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            //Picasso.with(getContext()).invalidate(url);
                             ...
                             Picasso.with(getContext()).load(url).memoryPolicy(MemoryPolicy.NO_CACHE).networkPolicy(NetworkPolicy.NO_CACHE).error(R.mipmap.ic_launcher_round).into(prof_img);
    ...
    public void logout() {
       ...
       // getActivity().getFragmentManager().popBackStack();
        //로그아웃 버튼을 누르면 기존의 액티비티 stack을 제거해준다.
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.add_interest:
                Intent intent = new Intent(getContext(), Interested_section_activity.class);
                startActivity(intent);

                break;
            case R.id.add_career:
                Intent intent2 = new Intent(getContext(), CareerActivity.class);
                startActivity(intent2);
                break;
            case R.id.add_exp:
                Intent intent3 = new Intent(getContext(), Profile_Detail.class);
                startActivity(intent3);
                break;
            case R.id.add_myskill:
                Intent intent4 = new Intent(getContext(), MySkillActivity.class);
